...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String LIFECYCLE_CALLBACK_TEXT_KEY = "lifecycle";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACK_TEXT_KEY)) {
                String restoreText = savedInstanceState.getString(LIFECYCLE_CALLBACK_TEXT_KEY);
                mLifecycleDisplay.setText(restoreText);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(LIFECYCLE_CALLBACK_TEXT_KEY, mLifecycleDisplay.getText().toString());
    }
